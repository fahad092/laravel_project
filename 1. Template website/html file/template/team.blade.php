			...
			<div class="row">
				<div class="col-md-3 col-sm-6 mb-5">
					<div class="teamy_preview">
						<img src="template/images/team1.jpg" class="teamy_avatar" alt="The demo photo">
					</div>
				...
				<div class="col-md-3 col-sm-6 mb-5">
					<div class="teamy_preview">
						<img src="template/images/team2.jpg" class="teamy_avatar" alt="The demo photo">
					</div>
					<div class="teamy_content mt-3">
				...
				<div class="col-md-3 col-sm-6 mb-5">
					<div class="teamy_preview">
						<img src="template/images/team3.jpg" class="teamy_avatar" alt="The demo photo">
					</div>    
					<div class="teamy_content mt-3">
				...
				<div class="col-md-3 col-sm-6  mb-5">
					<div class="teamy_preview">
						<img src="template/images/team4.jpg" class="teamy_avatar" alt="The demo photo">
					</div>
					<div class="teamy_content mt-3">
				...
				<div class="col-md-3 col-sm-6 mb-5">
					<div class="teamy_preview">
						<img src="template/images/team5.jpg" class="teamy_avatar" alt="The demo photo">
					</div>
					<div class="teamy_content mt-3">
						<h3 class="teamy_name">Suzan Lois</h3>
						<span class="teamy_post">Sales Executive</span>
				...
				<div class="col-md-3 col-sm-6 mb-5">
					<div class="teamy_preview">
						<img src="template/images/team6.jpg" class="teamy_avatar" alt="The demo photo">
					</div>
					<div class="teamy_content mt-3">
						<h3 class="teamy_name">Dora Caelan</h3>
						<span class="teamy_post">Product Manager</span>
				...
				<div class="col-md-3 col-sm-6 mb-5">
					<div class="teamy_preview">
						<img src="template/images/team7.jpg" class="teamy_avatar" alt="The demo photo">
					</div>    
					<div class="teamy_content mt-3">
						<h3 class="teamy_name">Rosanna</h3>
