...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!-- css files -->
    <link href="template/css/bootstrap.css" rel='stylesheet' type='text/css' /><!-- bootstrap css -->
    <link href="template/css/style.css" rel='stylesheet' type='text/css' /><!-- custom css -->
    <link href="template/css/font-awesome.min.css" rel="stylesheet"><!-- fontawesome css -->
	<!-- //css files -->
...
<header class="py-4">
	<div class="container">
			<div id="logo">
				<h1> <a href="index"><span class="fa fa-cloud" aria-hidden="true"></span> Digital</a></h1>
			</div>
		<!-- nav -->
		<nav class="d-lg-flex">
			...
			<ul class="menu mt-2 ml-auto">
				...
				<li class=""><a href="team">Team Page</a></li>
				<li class=""><a href="contact">Contact Page</a></li>
			</ul>
	...
	<div class="container">
		<div class="row banner-text">
			...
			<div class="col-lg-6 col-md-8 mt-lg-0 mt-sm-5 mt-3 banner-image text-lg-center">
				<img src="template/images/bannerpng.png" alt="" class="img-fluid"/>
			</div>
		</div>
	</div>
</div>
	...
	<div class="container py-lg-5 py-sm-3">
		<div class="row">
			...
			<div class="col-lg-4 col-md-5 about-img">
				<img src="template/images/1.png" alt="" class="img-fluid"/>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container py-md-3">
		...
		<div class="row process-grids">
			...
			<div class="col-lg-3 col-md-6 my-lg-4 mt-md-0 mt-4 w3pvt-ab position-relative">
				<div class="">
					<img src="template/images/2.png" alt="" class="img-fluid">
				</div>
			...
			<div class="col-lg-3 col-md-6 mt-lg-4 mt-sm-5 mt-4 w3pvt-ab">
				<div class="">
					<img src="itemplate/mages/2.png" alt="" class="img-fluid">
				</div>
		...
		<div class="inner-sec-w3ls py-lg-5 py-3">
			<div class="row">
				...
				<div class="col-lg-6 video-img mt-lg-0 mt-4">
					<img src="template/images/banner.png" alt="" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container py-3">
		...
		<div class="row news-grids text-center">
			<div class="col-md-3 col-6 gal-img">
				<a href="#gal1"><img src="template/images/g1.jpg" alt="portfolio image" class="img-fluid"></a>
			</div>
			<div class="col-md-3 col-6 gal-img">
				<a href="#gal2"><img src="template/images/g2.jpg" alt="portfolio image" class="img-fluid"></a>
			</div>
			<div class="col-md-3 col-6 gal-img">
				<a href="#gal3"><img src="template/images/g3.jpg" alt="portfolio image" class="img-fluid"></a>
			</div>
			<div class="col-md-3 col-6 gal-img">
				<a href="#gal4"><img src="template/images/g4.jpg" alt="portfolio image" class="img-fluid"></a>
			</div>
			<div class="col-md-3 col-6 gal-img">
				<a href="#gal5"><img src="template/images/g5.jpg" alt="portfolio image" class="img-fluid"></a>
			</div>
			<div class="col-md-3 col-6 gal-img">
				<a href="#gal6"><img src="template/images/g6.jpg" alt="portfolio image" class="img-fluid"></a>
			</div>
			<div class="col-md-3 col-6 gal-img">
				<a href="#gal7"><img src="template/images/g7.jpg" alt="portfolio image" class="img-fluid"></a>
			</div>
			<div class="col-md-3 col-6 gal-img">
				<a href="#gal8"><img src="template/images/g8.jpg" alt="portfolio image" class="img-fluid"></a>
			</div>
		</div>
		<!-- portfolio popups -->
			<!-- popup-->
...
<div id="popup1" class="popup-effect">
	<div class="popup">
		<img src="template/images/banner.png" alt="Popup Image" class="img-fluid" />
		...
		<div class="login px-sm-4 mx-auto mw-100">
			...
			<form action="login" method="post">
				...
				<div class="form-group">
					...
					<input type="email" name="email_address" class="form-control" id="email_address" aria-describedby="emailHelp" placeholder="" required="">
		...
		<div class="login px-sm-4 mx-auto mw-100">
			...
			<form action="registration" method="post">
				...
				<div class="form-group">
					...
					<input type="email" name="email_address" class="form-control" id="email_address" placeholder="" required="">
				</div>
				<div class="form-group">
					<label class="mb-2">Password</label>
